...
{
	//This is all string data and can be entered from one form to initially enter a candidate in the system.  
		//Recruitment team members should be able to update this at almost every step in the process.
	"firstName": "James",
	"lastName": "Hornung",
	...
	"university": "University of Texas at Austin",  //selected from a dropdown that is specific to the University chosen, 
														//generated by query to university collection
	"program": "FSF, Data, UIUX, etc",
	"role": "TA",  // Dropdown menu: Instructor, TA
	"notes": "blah blah blah",  //store specific info about candidate (former student, personal details, etc)
	"status": "HR Interview Pending",  //Dictates where in the flow the candidate is.  This field could be automatically updated on 
									   		//the submission of each form.  (ie when first entered in the system "HR Interview Pending", 
									   		//if hrInterview.result === "pass", update status to "Tech Interview Pending" etc...)
	...
	"hrInterview": {
		...
		"source": "string", // Dropdown menu: LinkedIn, Stack Overflow, AngelList, etc...
		"comments": "string",
		"result": "string"  // Dropdown menu: "Pass", "Fail"
	},
	"techInterview": {
