...

{
	...
	//this school field should be a string value that is selected from a dropdown, which is generated by the school names in the University collection.  (If there is not a university collection, this can be generated by an API call, important premise is a dropdown that is auto updated so that all the iniversity info can be updated by making a change in one place)
